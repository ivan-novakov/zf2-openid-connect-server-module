...
namespace InoOicServerTest\Authentication\Controller;

use InoOicServer\User\User;
use InoOicServer\Authentication\Controller\ShibbolethController;
use InoOicServer;
...
class ShibbolethControllerTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->setExpectedException('InoOicServer\Authentication\Controller\Exception\InvalidUserDataException', 'invalid data');
    ...
    public function testGetSystemVar()
    {
        ...
        $controller = $this->getMocK('InoOicServer\Authentication\Controller\ShibbolethController', array(
            'getSystemVars'
        ));
    ...
    {
        $this->setExpectedException('InoOicServer\Authentication\Controller\Exception\SessionNotFoundException');
    ...
    {
        $this->setExpectedException('InoOicServer\Authentication\Controller\Exception\MissingUserIdentityException');
    ...
    {
        return $this->getMock('InoOicServer\Authentication\Controller\ShibbolethController', $mockedMethods);
    }
    ...
    {
        $filter = $this->getMockBuilder('InoOicServer\Authentication\AttributeFilter')
    ...
    {
        $userFactory = $this->getMock('InoOicServer\User\UserFactoryInterface');
