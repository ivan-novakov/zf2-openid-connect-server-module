...
use InoOicServer\Authentication\AttributeFilter;
use InoOicServer\Authentication\Exception\CreateInputFilterException;
...
class AttributeFilterTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->setExpectedException('InoOicServer\Authentication\Exception\CreateInputFilterException');
    ...
    {
        $this->setExpectedException('InoOicServer\Authentication\Exception\InvalidInputException', 'Invalid input: ["message1","message2"]');
        ...
        array $expectedFilteredAttributes)
    {
        ...
        if (! $isValid) {
            $this->setExpectedException('InoOicServer\Authentication\Exception\InvalidInputException');
        }
