...
use InoOicServerTest\Framework\Config;
...
class MysqlLiteTest extends \PHPUnit_Extensions_Database_TestCase
{
    ...
    public function testSaveLoadSession ()
    {
        ...
        $this->assertInstanceOf('\InoOicServer\Session\Session', $loadedSession);
    ...
    public function testSaveLoadAuthorizationCode ()
    {
        ...
        $this->assertInstanceOf('\InoOicServer\Session\Token\AuthorizationCode', $loadedAuthorizationCode);
    ...
    public function testSaveLoadAccessToken ()
    {
        ...
        $this->assertInstanceOf('\InoOicServer\Session\Token\AccessToken', $loadedAccessToken);
